...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-rsc] (ecmascript)"); // Shared singleton (fixes multiple instances)
;
;
;
;
...
async function RootLayout({ children }) {
    ...
    if (session?.user.id) {
        ...
        }); // Logic: Fixed 'profile' → 'profiles' (match schema.prisma model name)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__620f1080._.js.map