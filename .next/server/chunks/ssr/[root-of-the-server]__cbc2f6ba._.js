...
"[project]/wraelen/wraelen-internal-boilerplate/src/lib/supabaseClient.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
let clientSupabase = null; // Logic: Global memo (avoids multiple GoTrueClient – fixes undefined session behavior; push back: Raw createClient can share localStorage key, causing bugs)
const getClientSupabase = ()=>{
    if (!clientSupabase) {
        clientSupabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$wraelen$2f$wraelen$2d$internal$2d$boilerplate$2f$node_modules$2f2e$pnpm$2f40$supabase$2b$supabase$2d$js$40$2$2e$58$2e$0$2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseAnonKey); // Logic: Create once (efficient – uses public vars for browser; no cookies on client as sessions persist via localStorage/JWT)
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$wraelen$2f$wraelen$2d$internal$2d$boilerplate$2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/wraelen/wraelen-internal-boilerplate/src/lib/supabaseClient.ts [app-ssr] (ecmascript)"); // Updated: Singleton utility (logic: Memoized client – fixes multiple GoTrueClient warning; best for browser context consistency)
...
function SignIn() {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$wraelen$2f$wraelen$2d$internal$2d$boilerplate$2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getClientSupabase"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cbc2f6ba._.js.map