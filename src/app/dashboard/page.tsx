...
export default async function Dashboard() {
  ...
  const profile = await prisma.profile.findUnique({ where: { userId: session.user.id } });  // Logic: Fetch gamification data (relational – efficient query; push back: If no profile, create on-the-fly or handle error for robustness)
